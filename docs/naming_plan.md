# Naming & Numbering Plan — Phase 6 Deliverable (APPROVED — EXECUTED IN 7b/7c, 2026-07-08)

> **Execution record:** all P1/P2 notebook renames applied via `git mv` 2026-07-08; `all.ipynb` archived to `note_books/archive/`; all artifact renames/moves applied with hash verification and preserved originals in `archive/pre_7c/` + `backup_7bc_2026-07-08/`; the D2 generation files were built and validated in 7c (`docs/manifests/validation_7c_2026-07-08.md`). P3 items (temp-req/passed folder names, `_raw` suffix, `note_books/` folder, merge-artifact consistency renames) remain deferred as planned.

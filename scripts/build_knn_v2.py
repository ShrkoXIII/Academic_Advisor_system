"""Build the GPA-nearest KNN v2 artifact from the two history tables."""
...
from src.knn_advisor_v2 import KNNAdvisorV2  # noqa: E402
...
DEFAULT_OUTPUT = DEFAULT_HISTORY_DIR / "knn_v2_gpa_nearest.pkl"
...
def main() -> None:
    ...
    print(f"KNN v2 artifact: {args.output}")

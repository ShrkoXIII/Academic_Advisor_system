# seed52-baseline-41-gpa-trend-control

**Run ID:** 2026-07-27_1027__seed52-baseline-41-gpa-trend-control
**Date:** 2026-07-27T10:27:12+03:00
**Features:** 41
**Compared with:** none

## What changed

- seed52_baseline_41_controlled_multiseed_TEST_closed_not_read
...
- M1 valid fail-class Average Precision: 0.3224 (no baseline)
- M1 valid AUC: 0.8100 (no baseline)
- M1 valid Brier: 0.0807 (no baseline)
- M1 train-valid AUC gap: 0.0687 (no baseline)

## M2 regressor

- M2 valid MAE: 9.5715 (no baseline)
- M2 valid RMSE: 12.8552 (no baseline)
- M2 valid R2: 0.3519 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.3210 (no baseline)
- M1 valid fail recall: 0.4431 (no baseline)
- M1 valid fail F1: 0.3723 (no baseline)
...
- low_difficulty_support valid AUC (n=25627): 0.7653 (no baseline)
- retake_attempt valid AUC (n=17958): 0.6734 (no baseline)

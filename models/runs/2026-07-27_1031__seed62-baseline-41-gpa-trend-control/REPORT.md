# seed62-baseline-41-gpa-trend-control

**Run ID:** 2026-07-27_1031__seed62-baseline-41-gpa-trend-control
**Date:** 2026-07-27T10:31:59+03:00
**Features:** 41
**Compared with:** none

## What changed

- seed62_baseline_41_controlled_multiseed_TEST_closed_not_read
...
- M1 valid fail-class Average Precision: 0.3233 (no baseline)
- M1 valid AUC: 0.8092 (no baseline)
- M1 valid Brier: 0.0807 (no baseline)
- M1 train-valid AUC gap: 0.0616 (no baseline)

## M2 regressor

- M2 valid MAE: 9.5387 (no baseline)
- M2 valid RMSE: 12.8081 (no baseline)
- M2 valid R2: 0.3566 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.3283 (no baseline)
- M1 valid fail recall: 0.4200 (no baseline)
- M1 valid fail F1: 0.3685 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=14732): 0.7284 (no baseline)
- first_semester valid AUC (n=14732): 0.7284 (no baseline)
- low_difficulty_support valid AUC (n=25627): 0.7624 (no baseline)
- retake_attempt valid AUC (n=17958): 0.6760 (no baseline)

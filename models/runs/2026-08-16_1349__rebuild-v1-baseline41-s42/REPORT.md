# rebuild-v1-baseline41-s42

**Run ID:** 2026-08-16_1349__rebuild-v1-baseline41-s42
**Date:** 2026-08-16T13:49:04+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v1, seed 42
...
- M1 valid fail-class Average Precision: 0.2512 (no baseline)
- M1 valid AUC: 0.8054 (no baseline)
- M1 valid Brier: 0.0652 (no baseline)
- M1 train-valid AUC gap: 0.0779 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8777 (no baseline)
- M2 valid RMSE: 13.5239 (no baseline)
- M2 valid R2: 0.3071 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2536 (no baseline)
- M1 valid fail recall: 0.4260 (no baseline)
- M1 valid fail F1: 0.3179 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6559 (no baseline)
- first_semester valid AUC (n=7162): 0.6559 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7361 (no baseline)
- retake_attempt valid AUC (n=6700): 0.6745 (no baseline)

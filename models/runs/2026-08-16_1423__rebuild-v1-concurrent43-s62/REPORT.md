# rebuild-v1-concurrent43-s62

**Run ID:** 2026-08-16_1423__rebuild-v1-concurrent43-s62
**Date:** 2026-08-16T14:23:00+03:00
**Features:** 43
**Compared with:** 2026-08-16_1355__rebuild-v1-baseline41-s62
...
- M1 valid fail-class Average Precision: 0.2519 -> 0.2522 (+0.0004)
- M1 valid AUC: 0.8061 -> 0.8055 (-0.0006)
- M1 valid Brier: 0.0652 -> 0.0651 (-0.0001)
- M1 train-valid AUC gap: 0.0833 -> 0.0754 (-0.0079)

## M2 regressor

- M2 valid MAE: 9.8724 -> 9.8672 (-0.0052)
- M2 valid RMSE: 13.5154 -> 13.5012 (-0.0142)
- M2 valid R2: 0.3080 -> 0.3094 (+0.0014)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2512 -> 0.2521 (+0.0009)
- M1 valid fail recall: 0.4253 -> 0.4293 (+0.0040)
- M1 valid fail F1: 0.3158 -> 0.3176 (+0.0018)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6499 -> 0.6483 (-0.0016)
- first_semester valid AUC (n=7162): 0.6499 -> 0.6483 (-0.0016)
- low_difficulty_support valid AUC (n=1203): 0.7356 -> 0.7283 (-0.0073)
- retake_attempt valid AUC (n=6700): 0.6789 -> 0.6773 (-0.0016)

# rebuild-v2-baseline41-s72

**Run ID:** 2026-08-18_1645__rebuild-v2-baseline41-s72
**Date:** 2026-08-18T16:45:27+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v2, seed 72, patience 120
...
- M1 valid fail-class Average Precision: 0.2435 (no baseline)
- M1 valid AUC: 0.8077 (no baseline)
- M1 valid Brier: 0.0632 (no baseline)
- M1 train-valid AUC gap: 0.0640 (no baseline)

## M2 regressor

- M2 valid MAE: 9.6634 (no baseline)
- M2 valid RMSE: 12.8646 (no baseline)
- M2 valid R2: 0.3344 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2494 (no baseline)
- M1 valid fail recall: 0.4193 (no baseline)
- M1 valid fail F1: 0.3128 (no baseline)
...
- low_difficulty_support valid AUC (n=1202): 0.7280 (no baseline)
- retake_attempt valid AUC (n=6626): 0.6789 (no baseline)

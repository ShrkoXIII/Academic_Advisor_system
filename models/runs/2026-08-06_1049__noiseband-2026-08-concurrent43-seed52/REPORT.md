# noiseband-2026-08-concurrent43-seed52

**Run ID:** 2026-08-06_1049__noiseband-2026-08-concurrent43-seed52
**Date:** 2026-08-06T10:49:35+03:00
**Features:** 43
**Compared with:** none

## What changed

- Noise-band measurement on 2026-08_temporal_rebuild_v1; seed 52; M2 locked concurrent_43; no tuning.
...
- M1 valid fail-class Average Precision: 0.2554 (no baseline)
- M1 valid AUC: 0.8070 (no baseline)
- M1 valid Brier: 0.0649 (no baseline)
- M1 train-valid AUC gap: 0.0711 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8424 (no baseline)
- M2 valid RMSE: 13.4644 (no baseline)
- M2 valid R2: 0.3129 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2541 (no baseline)
- M1 valid fail recall: 0.4417 (no baseline)
- M1 valid fail F1: 0.3226 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6489 (no baseline)
- first_semester valid AUC (n=7162): 0.6489 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7233 (no baseline)
- retake_attempt valid AUC (n=6701): 0.6838 (no baseline)

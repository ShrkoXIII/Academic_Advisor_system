# noiseband-2026-08-baseline41-seed42

**Run ID:** 2026-08-06_1043__noiseband-2026-08-baseline41-seed42
**Date:** 2026-08-06T10:43:28+03:00
**Features:** 41
**Compared with:** none

## What changed

- Noise-band measurement on 2026-08_temporal_rebuild_v1; seed 42; M1 locked baseline_41; no tuning.
...
- M1 valid fail-class Average Precision: 0.2546 (no baseline)
- M1 valid AUC: 0.8051 (no baseline)
- M1 valid Brier: 0.0650 (no baseline)
- M1 train-valid AUC gap: 0.0790 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8397 (no baseline)
- M2 valid RMSE: 13.4933 (no baseline)
- M2 valid R2: 0.3100 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2551 (no baseline)
- M1 valid fail recall: 0.4277 (no baseline)
- M1 valid fail F1: 0.3196 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6567 (no baseline)
- first_semester valid AUC (n=7162): 0.6567 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7328 (no baseline)
- retake_attempt valid AUC (n=6701): 0.6815 (no baseline)

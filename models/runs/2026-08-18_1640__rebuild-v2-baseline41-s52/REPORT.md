# rebuild-v2-baseline41-s52

**Run ID:** 2026-08-18_1640__rebuild-v2-baseline41-s52
**Date:** 2026-08-18T16:40:45+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v2, seed 52, patience 120
...
- M1 valid AUC: 0.8082 (no baseline)
- M1 valid Brier: 0.0634 (no baseline)
- M1 train-valid AUC gap: 0.0799 (no baseline)

## M2 regressor

- M2 valid MAE: 9.6752 (no baseline)
- M2 valid RMSE: 12.8790 (no baseline)
- M2 valid R2: 0.3329 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2502 (no baseline)
- M1 valid fail recall: 0.4322 (no baseline)
- M1 valid fail F1: 0.3169 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7148): 0.6562 (no baseline)
- first_semester valid AUC (n=7148): 0.6562 (no baseline)
- low_difficulty_support valid AUC (n=1202): 0.7439 (no baseline)
- retake_attempt valid AUC (n=6626): 0.6748 (no baseline)

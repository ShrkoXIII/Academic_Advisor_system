# rebuild-v1-baseline41-s52

**Run ID:** 2026-08-16_1354__rebuild-v1-baseline41-s52
**Date:** 2026-08-16T13:54:16+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v1, seed 52
...
- M1 valid AUC: 0.8044 (no baseline)
- M1 valid Brier: 0.0652 (no baseline)
- M1 train-valid AUC gap: 0.0729 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8814 (no baseline)
- M2 valid RMSE: 13.5215 (no baseline)
- M2 valid R2: 0.3074 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2519 (no baseline)
- M1 valid fail recall: 0.4195 (no baseline)
- M1 valid fail F1: 0.3148 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6516 (no baseline)
- first_semester valid AUC (n=7162): 0.6516 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7249 (no baseline)
- retake_attempt valid AUC (n=6700): 0.6763 (no baseline)

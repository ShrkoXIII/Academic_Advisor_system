# rebuild-v2-baseline41-s82

**Run ID:** 2026-08-18_1647__rebuild-v2-baseline41-s82
**Date:** 2026-08-18T16:47:05+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v2, seed 82, patience 120
...
- M1 valid fail-class Average Precision: 0.2403 (no baseline)
- M1 valid AUC: 0.8067 (no baseline)
- M1 valid Brier: 0.0636 (no baseline)
- M1 train-valid AUC gap: 0.0794 (no baseline)

## M2 regressor

- M2 valid MAE: 9.6722 (no baseline)
- M2 valid RMSE: 12.8905 (no baseline)
- M2 valid R2: 0.3317 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2479 (no baseline)
- M1 valid fail recall: 0.4289 (no baseline)
- M1 valid fail F1: 0.3142 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7148): 0.6532 (no baseline)
- first_semester valid AUC (n=7148): 0.6532 (no baseline)
- low_difficulty_support valid AUC (n=1202): 0.7319 (no baseline)
- retake_attempt valid AUC (n=6626): 0.6770 (no baseline)

# rebuild-v1-baseline41-s62

**Run ID:** 2026-08-16_1355__rebuild-v1-baseline41-s62
**Date:** 2026-08-16T13:55:33+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v1, seed 62
...
- M1 valid fail-class Average Precision: 0.2519 (no baseline)
- M1 valid AUC: 0.8061 (no baseline)
- M1 valid Brier: 0.0652 (no baseline)
- M1 train-valid AUC gap: 0.0833 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8724 (no baseline)
- M2 valid RMSE: 13.5154 (no baseline)
- M2 valid R2: 0.3080 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2512 (no baseline)
- M1 valid fail recall: 0.4253 (no baseline)
- M1 valid fail F1: 0.3158 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6499 (no baseline)
- first_semester valid AUC (n=7162): 0.6499 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7356 (no baseline)
- retake_attempt valid AUC (n=6700): 0.6789 (no baseline)

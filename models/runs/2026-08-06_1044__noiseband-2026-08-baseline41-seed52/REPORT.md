# noiseband-2026-08-baseline41-seed52

**Run ID:** 2026-08-06_1044__noiseband-2026-08-baseline41-seed52
**Date:** 2026-08-06T10:44:53+03:00
**Features:** 41
**Compared with:** none

## What changed

- Noise-band measurement on 2026-08_temporal_rebuild_v1; seed 52; M1 locked baseline_41; no tuning.
...
- M1 valid fail-class Average Precision: 0.2505 (no baseline)
- M1 valid AUC: 0.8050 (no baseline)
- M1 valid Brier: 0.0652 (no baseline)
- M1 train-valid AUC gap: 0.0744 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8412 (no baseline)
- M2 valid RMSE: 13.4888 (no baseline)
- M2 valid R2: 0.3104 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2521 (no baseline)
- M1 valid fail recall: 0.4250 (no baseline)
- M1 valid fail F1: 0.3165 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6465 (no baseline)
- first_semester valid AUC (n=7162): 0.6465 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7307 (no baseline)
- retake_attempt valid AUC (n=6701): 0.6784 (no baseline)

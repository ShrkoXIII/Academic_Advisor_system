# rebuild-v1-baseline41-s82

**Run ID:** 2026-08-16_1358__rebuild-v1-baseline41-s82
**Date:** 2026-08-16T13:58:15+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v1, seed 82
...
- M1 valid fail-class Average Precision: 0.2533 (no baseline)
- M1 valid AUC: 0.8062 (no baseline)
- M1 valid Brier: 0.0650 (no baseline)
- M1 train-valid AUC gap: 0.0702 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8751 (no baseline)
- M2 valid RMSE: 13.5312 (no baseline)
- M2 valid R2: 0.3064 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2553 (no baseline)
- M1 valid fail recall: 0.4212 (no baseline)
- M1 valid fail F1: 0.3179 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6578 (no baseline)
- first_semester valid AUC (n=7162): 0.6578 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7373 (no baseline)
- retake_attempt valid AUC (n=6700): 0.6802 (no baseline)

# seed72-concurrent-44-registration-roster-candidate

**Run ID:** 2026-07-27_1036__seed72-concurrent-44-registration-roster-candidate
**Date:** 2026-07-27T10:36:43+03:00
**Features:** 44
**Compared with:** 2026-07-27_1035__seed72-baseline-41-gpa-trend-control

## What changed

- seed72_concurrent_44_controlled_multiseed_TEST_closed_not_read
...
- M1 valid fail-class Average Precision: 0.3221 -> 0.3237 (+0.0015)
- M1 valid AUC: 0.8095 -> 0.8106 (+0.0010)
- M1 valid Brier: 0.0807 -> 0.0807 (-0.0001)
- M1 train-valid AUC gap: 0.0582 -> 0.0523 (-0.0059)

## M2 regressor

- M2 valid MAE: 9.5492 -> 9.5366 (-0.0126)
- M2 valid RMSE: 12.8356 -> 12.8137 (-0.0219)
- M2 valid R2: 0.3539 -> 0.3561 (+0.0022)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.3341 -> 0.3368 (+0.0027)
- M1 valid fail recall: 0.4252 -> 0.4169 (-0.0083)
- M1 valid fail F1: 0.3742 -> 0.3726 (-0.0016)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=14732): 0.7354 -> 0.7389 (+0.0035)
- first_semester valid AUC (n=14732): 0.7354 -> 0.7389 (+0.0035)
- low_difficulty_support valid AUC (n=25627): 0.7689 -> 0.7709 (+0.0020)
- retake_attempt valid AUC (n=17958): 0.6753 -> 0.6786 (+0.0033)

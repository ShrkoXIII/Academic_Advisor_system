# rebuild-v1-baseline41-s72

**Run ID:** 2026-08-16_1357__rebuild-v1-baseline41-s72
**Date:** 2026-08-16T13:57:07+03:00
**Features:** 41
**Compared with:** none

## What changed

- baseline_41 on 2026-08_temporal_rebuild_v1, seed 72
...
- M1 valid fail-class Average Precision: 0.2489 (no baseline)
- M1 valid AUC: 0.8034 (no baseline)
- M1 valid Brier: 0.0649 (no baseline)
- M1 train-valid AUC gap: 0.0515 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8795 (no baseline)
- M2 valid RMSE: 13.5335 (no baseline)
- M2 valid R2: 0.3061 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2568 (no baseline)
- M1 valid fail recall: 0.3933 (no baseline)
- M1 valid fail F1: 0.3108 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6606 (no baseline)
- first_semester valid AUC (n=7162): 0.6606 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7329 (no baseline)
- retake_attempt valid AUC (n=6700): 0.6738 (no baseline)

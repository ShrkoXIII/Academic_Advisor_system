# noiseband-2026-08-baseline41-seed82

**Run ID:** 2026-08-06_1047__noiseband-2026-08-baseline41-seed82
**Date:** 2026-08-06T10:47:43+03:00
**Features:** 41
**Compared with:** none

## What changed

- Noise-band measurement on 2026-08_temporal_rebuild_v1; seed 82; M1 locked baseline_41; no tuning.
...
- M1 valid Brier: 0.0647 (no baseline)
- M1 train-valid AUC gap: 0.0539 (no baseline)

## M2 regressor

- M2 valid MAE: 9.8490 (no baseline)
- M2 valid RMSE: 13.5064 (no baseline)
- M2 valid R2: 0.3086 (no baseline)

## Fail-class at the locked reporting threshold (VALID)

- M1 valid fail precision: 0.2591 (no baseline)
- M1 valid fail recall: 0.4057 (no baseline)
- M1 valid fail F1: 0.3162 (no baseline)

## Segment result (VALID; existing segment definitions only)

- cold_start_gpa valid AUC (n=7162): 0.6607 (no baseline)
- first_semester valid AUC (n=7162): 0.6607 (no baseline)
- low_difficulty_support valid AUC (n=1203): 0.7303 (no baseline)
- retake_attempt valid AUC (n=6701): 0.6777 (no baseline)
